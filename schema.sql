...
-- create device table
create table DAT_Devices (id integer primary key, name text, idDeviceType int, idCategory int);

-- create file table
create table DAT_Files (id integer primary key, idDevice integer, idParentDir integer, name text, bits integer, userId integer, groupId integer, size integer, aTime real, mTime real, mime text);

-- create categories table
create table DAT_Categories (id integer primary key, name text);

-- create directory table DAT_Directory
